	...
	public function about_screen() {
		...
		<div class="wrap wplms-wrap about-wrap">
			...
			<div class="changelog">
				<div class="wplms-feature feature-rest feature-section col two-col">
					<div class="col-1">
						<h4><?php _e( '50 Bugs fixes and Updates', 'vibe' ); ?></h4>
					...
					<div class="col-2">
						<h4><?php _e( '5 New features added', 'vibe' ); ?></h4>
						<p><?php _e( 'We added 5 new features in the theme and plugins.<br />WPLMS One Click setup, WPLMS Dashboards,Instructor only Pages,Course Category Filters and Extend subscription from Course Admin', 'vibe' ); ?></p>
			...
			<div class="changelog about-integrations">
				<h3><?php _e( 'WPLMS Latest Tutorials', 'vibe' ); ?></h3>
				<div class="wplms-feature feature-section col three-col">
					<div>
						<h4><?php _e( 'Instructor Dashboards', 'vibe' ); ?></h4>
						<p><iframe width="100%" height="200px" src="//www.youtube.com/embed/qLx97Z0TyXs" frameborder="0" allowfullscreen></iframe></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/31519-tip-wplms-dashboards">Tutorial</a>
					</div>
					<div>
						<h4><?php _e( 'Instructor Commissions', 'vibe' ); ?></h4>
						<p><iframe width="100%" height="200px" src="//www.youtube.com/embed/MEajjLIEzao" frameborder="0" allowfullscreen></iframe></p>
						<a href="http://vibethemes.com/forums/forum/wordpress-html-css/wordpress-themes/wplms/tips-tricks-docs/30814-tip-how-instructor-commissions-are-calculated-in-wplms">Tutorial</a>
					</div>
					<div class="last-feature">
						<h4><?php _e( 'Front End Quiz creation', 'vibe' ); ?></h4>
						<p><iframe width="100%" height="200px" src="//www.youtube.com/embed/k342Fu_opiA" frameborder="0" allowfullscreen></iframe></p>
					</div>
				</div>
			</div>
			<div class="changelog">
				<div class="feature-section col three-col">
					<div>
						<h4><?php _e( 'WPLMS CoAuthors Plus Updated', 'vibe' ); ?></h4>
						<p><?php _e( 'If you\'re using WP CoAuthors Plus with WPLMS, then we have updated the WPLMS CoAuthors Plus add on plugin for Instructor commisions feature. You need to deactivate/delete the current WPLMS CoAuthors Add on plugin and download a fresh one form below link and install it.', 'vibe' ); ?></p>
						<a href="https://github.com/MrVibe/WPLMS-Coauthors-Plus/archive/master.zip" class="button"><?php _e( 'Download', 'vibe' ); ?></a>
					</div>
					<div>
						<h4><?php _e( 'BadgeOS Addon Fixed', 'vibe' ); ?></h4>
						<p><?php _e( 'BadgeOs addon has been updated with several fixes, especially for Manual evaluation of courses/quiz.You need to deactivate/delete the current WPLMS BadeOs Add on plugin and download a fresh one form below link and install it.', 'vibe' ); ?></p>
						<a href="https://github.com/VibeThemes/WPLMS-BadgeOS/archive/master.zip" class="button"><?php _e( 'Download', 'vibe' ); ?></a>
					</div>
					<div class="last-feature">
