  ...
  <div class="row">
      ...
      <div class="widget">
        <div class="blog-posts single-post clearfix">
          <article class="post post-large blog-single-post">
            <div class="post-image"> <img src="<?php bloginfo('template_url');?>/assets/images/blog-image-1.jpg" class="img-responsive"> </div>
            ...
            <div class="post-content">
              ...
              <div class="post-meta"> <span><i class="fa fa-user"></i> By <a href="#">John Doe</a> </span> <span><i class="fa fa-tag"></i> <a href="#">Duis</a>, <a href="#">News</a> </span> <span><i class="fa fa-comments"></i> <a href="#">12 Comments</a></span> </div>
              ...
              <div class="post-block post-author clearfix">
                ...
                <div class="img-thumbnail"> <a href="blog-post.html"> <img src="<?php bloginfo('template_url');?>/assets/images/avatar.jpg" alt=""> </a> </div>
              ...
              <div class="post-block post-comments clearfix">
                ...
                <ul class="comments">
                  <li>
                    <div class="comment">
                      <div class="img-thumbnail"> <img class="avatar" alt="" src="<?php bloginfo('template_url');?>/assets/images/avatar-2.jpg"> </div>
                      <div class="comment-block">
                        <div class="comment-arrow"></div>
                        <span class="comment-by"> <strong>John Doe</strong> <span class="pull-right"> <span> <a href="#"><i class="fa fa-reply"></i> Reply</a></span> </span> </span>
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae, gravida pellentesque urna varius vitae. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae. Sed dui lorem, adipiscing in adipiscing et, interdum nec metus. Mauris ultricies, justo eu convallis placerat, felis enim ornare nisi, vitae mattis nulla ante id dui.</p>
                        <span class="date pull-right">January 12, 2013 at 1:38 pm</span> </div>
                    </div>
                    <ul class="comments reply">
                      <li>
                        <div class="comment">
                          <div class="img-thumbnail"> <img class="avatar" alt="" src="<?php bloginfo('template_url');?>/assets/images/avatar-3.jpg"> </div>
                          <div class="comment-block">
                            <div class="comment-arrow"></div>
                            <span class="comment-by"> <strong>John Doe</strong> <span class="pull-right"> <span> <a href="#"><i class="fa fa-reply"></i> Reply</a></span> </span> </span>
                      ...
                      <li>
                        <div class="comment">
                          <div class="img-thumbnail"> <img class="avatar" alt="" src="<?php bloginfo('template_url');?>/assets/images/avatar-4.jpg"> </div>
                          <div class="comment-block">
                            <div class="comment-arrow"></div>
                            <span class="comment-by"> <strong>John Doe</strong> <span class="pull-right"> <span> <a href="#"><i class="fa fa-reply"></i> Reply</a></span> </span> </span>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida pellentesque urna varius vitae, gravida pellentesque urna varius vitae.</p>
                  ...
                  <li>
                    <div class="comment">
                      <div class="img-thumbnail"> <img class="avatar" alt="" src="<?php bloginfo('template_url');?>/assets/images/avatar.jpg"> </div>
                      <div class="comment-block">
                        <div class="comment-arrow"></div>
                        <span class="comment-by"> <strong>John Doe</strong> <span class="pull-right"> <span> <a href="#"><i class="fa fa-reply"></i> Reply</a></span> </span> </span>
    ...
    <div class="col-md-3">
      <div class="small_widget">
        <div class="blog_sidebar clearfix">
          <form>
          ...
          <ul class="simple-post-list">
            <li>
              <div class="post-image">
                <div class="img-thumbnail"> <a href="javascript:;"> <img src="<?php bloginfo('template_url');?>/assets/images//blog-thumb-1.jpg" alt=""> </a> </div>
              </div>
              <div class="post-info"> <a href="javascript:;">Nullam Vitae Nibh Un Odiosters</a>
                <div class="post-meta"> Jan 10, 2013 </div>
              </div>
            </li>
            <li>
              <div class="post-image">
                <div class="img-thumbnail"> <a href="javascript:;"> <img src="<?php bloginfo('template_url');?>/assets/images//blog-thumb-2.jpg" alt=""> </a> </div>
              </div>
              <div class="post-info"> <a href="javascript:;">Vitae Nibh Un Odiosters</a>
                <div class="post-meta"> Jan 10, 2013 </div>
              </div>
            </li>
            <li>
              <div class="post-image">
                <div class="img-thumbnail"> <a href="javascript:;"> <img src="<?php bloginfo('template_url');?>/assets/images//blog-thumb-3.jpg" alt=""> </a> </div>
              </div>
              <div class="post-info"> <a href="javascript:;">Odiosters Nullam Vitae</a>
                <div class="post-meta"> Jan 10, 2013 </div>
              </div>
            </li>
          </ul>
      ...
      <div class="small_widget">
        <div class="add_area"> <a href="javascript:;"> <img alt="*" src="<?php bloginfo('template_url');?>/assets/images/ad_1.jpg" class="img-responsive"> </a> <a href="javascript:;"> <img alt="*" src="<?php bloginfo('template_url');?>/assets/images/ad_2.jpg" class="img-responsive"> </a> </div>
      </div>
    </div>
  </div>
</div>
